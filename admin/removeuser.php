...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../receipt/paginator.css" type="text/css" media="screen" />
        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <section id="main" class="column">
            ...
            <article class="module width_full">
                <header><h3 class="tabs_involved">Pending User Request
                ...
                <br/>
                <?php
                define('include_inbox_class', TRUE);
                include_once '../receipt/inbox_class.php';
                $inbox = new inbox_class();
                $inbox->inbox_content($_SESSION['username'], 'deluser');
                ?>
