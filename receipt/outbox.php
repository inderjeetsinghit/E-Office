    ...
    <body>
        ...
        <section id="main" class="column">
            ...
            <article class="module width_full">
                <header><h3 class="tabs_involved">Outbox
                ...
                <?php
                define('include_outbox_class', TRUE);
                include_once 'outbox_class.php';
                $outbox = new outbox_class();
                $outbox->outbox_content($_SESSION['username']);
                ?>
